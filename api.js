...
//                 </svg>
//             </span>
//             <p id="address">${user.address.address}</p>
...
//         document.querySelector('#address-edit').value = userData.address.address
//         document.querySelector('#dob-edit').value = userData.birthDate
//         document.querySelector('#age-edit').value = userData.age
//         document.querySelector('#gender-edit').textContent = userData.gender
...
//                 userData.address.address = document.querySelector('#address-edit').value
//                 userData.birthDate = document.querySelector('#dob-edit').value
//                 userData.age = document.querySelector('#age-edit').value
//                 userData.gender = document.querySelector('#gender-edit').textContent

//                 myArray[index] = userData;
//                 console.log("My Array Data " + myArray[index].firstName);
...
window.addEventListener('newUserCreated', (event) => {
    const newUser = event.detail;
    console.log('New user data received:', newUser);
    // Now you can use newUser
    myArray.push(newUser);
});
console.log("Hellow from Api.js");
